...
#if MATCH_OPLUS_NFC
#define NFC_VDDIO_EN_NAME	"qcom,sn-vddio-en"
#define NFC_SWITCH_EN_NAME 	"qcom,sn-switch-en"
#endif
...
#if MATCH_OPLUS_NFC
	unsigned int vddio_ven;
	unsigned int switch_ven;
#endif
};
