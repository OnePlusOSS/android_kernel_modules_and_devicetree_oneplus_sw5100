...
enum Tfa98xx_Error tfa98xx_init_v6(struct tfa_device *tfa)
{
	...
	if (Tfa98xx_Error_Ok != tfa98xx_set_intp_v6(tfa, 1)) {
		pr_err("%s %d: Failed to set intp\n", __func__, __LINE__);
	} else {
		pr_info("%s: set intp to 1 (active high)\n", __func__, __LINE__);
	}
	return error;
}
...
enum Tfa98xx_Error tfa98xx_set_intp_v6(struct tfa_device *tfa, uint16_t value)
{
	return -tfa_set_bf_v6(tfa, TFA9873_BF_INTP, value);
}

int tfa98xx_get_intp_v6(struct tfa_device *tfa)
{
	return tfa_get_bf_v6(tfa, TFA9873_BF_INTP);
}
...
enum Tfa98xx_Error tfa98xx_get_volume_level(struct tfa_device *tfa, unsigned short* vol)
{
	*vol = TFA_GET_BF(tfa, VOL);
	if (*vol < 0)
...
int tfa_switch_reg_revert(struct tfa_device *tfa)
{
	//gain to 15dB
	tfa_set_bf_v6(tfa, TFA9873_BF_TDMSPKG, 6);
	//48 kb
    tfa_set_bf_v6(tfa, TFA9873_BF_AUDFS, 8);
    //32bit - 2ch
    tfa_set_bf_v6(tfa, TFA9873_BF_TDMNBCK, 2);
    tfa_set_bf_v6(tfa, TFA9873_BF_TDMSLLN, 31);
    tfa_set_bf_v6(tfa, TFA9873_BF_TDMSSIZE, 31);
    tfa_set_bf_v6(tfa, TFA9873_BF_TDMCSS, 0);
    tfa_set_bf_v6(tfa, TFA9873_BF_TDMVSS, 1);
    tfa_set_bf_v6(tfa, TFA9873_BF_TDMSRCMAP, 3);

    tfa_set_bf_v6(tfa, TFA9873_BF_TDMCSE, 1);
    tfa_set_bf_v6(tfa, TFA9873_BF_TDMVSE, 0);
    tfa_set_bf_v6(tfa, TFA9873_BF_TDMSRCAS, 1);
    tfa_set_bf_v6(tfa, TFA9873_BF_TDMSRCBS, 2);

    // default set to 0 profile: Music_48000
    // tfa_dev_set_swprof(tfa, 0);
    pr_info("Switched default(48000-32-2) ");
