...
LOCAL_MODULE_KBUILD_NAME  := asoc/codecs/oplus/audio_extend_dlkm.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/Build_external_kernelmodule.mk
...
LOCAL_MODULE_KBUILD_NAME  := asoc/codecs/tfa98xx-v6/tfa98xx_dlkm.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/Build_external_kernelmodule.mk
...
BOARD_VENDOR_KERNEL_MODULES += $(KERNEL_MODULES_OUT)/q6_pdr_dlkm.ko \
...
BOARD_VENDOR_RAMDISK_KERNEL_MODULES += $(KERNEL_MODULES_OUT)/q6_pdr_dlkm.ko \
					$(KERNEL_MODULES_OUT)/q6_notifier_dlkm.ko \
					$(KERNEL_MODULES_OUT)/snd_event_dlkm.ko \
					$(KERNEL_MODULES_OUT)/gpr_dlkm.ko \
					$(KERNEL_MODULES_OUT)/spf_core_dlkm.ko \
					...
					$(KERNEL_MODULES_OUT)/machine_dlkm.ko \
					$(KERNEL_MODULES_OUT)/audpkt_ion_dlkm.ko
BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD += $(KERNEL_MODULES_OUT)/q6_pdr_dlkm.ko \
							$(KERNEL_MODULES_OUT)/q6_notifier_dlkm.ko \
							$(KERNEL_MODULES_OUT)/snd_event_dlkm.ko \
							$(KERNEL_MODULES_OUT)/gpr_dlkm.ko \
							$(KERNEL_MODULES_OUT)/spf_core_dlkm.ko \
