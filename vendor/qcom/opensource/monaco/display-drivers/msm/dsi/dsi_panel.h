...
#define PANEL_VISIONOX_NT37350_174    0x097006
#define PANEL_BOE_FT2389_191          0x108002
#define PANEL_BOE_FT2389_191_V2       0x108003
#define PANEL_BOE_FT2389_169          0x097007
#define PANEL_TM_ICNA3311_143         0x095001

#define IS_PANEL_FT2389(panel_id) ((panel_id == PANEL_BOE_FT2389_191) || \
				(panel_id == PANEL_BOE_FT2389_191_V2) || \
				(panel_id == PANEL_BOE_FT2389_169))

#define IS_PANEL_ICNA3311(panel_id) (panel_id == PANEL_TM_ICNA3311_143)

#define PMIC_GPIO_BASE     (384) /*PM5100 IO*/
#define G_GPIO_BASE        (400) /*SW5100 IO*/
#define DISP_POWER_IC_3p3  (PMIC_GPIO_BASE)     /*display power ic 3p3 pm_gpio_01*/
#define DISP_RST           (PMIC_GPIO_BASE + 1) /*display reset pm_gpio_02*/
#define TP_RST             (G_GPIO_BASE +12)    /*tp rset gpio_12*/
#define DISP_LDO_3P3       (G_GPIO_BASE + 23)   /*display ldo 3p3 gpio _23*/
#define DISP_1P8           (G_GPIO_BASE + 39)   /*display 1p8 gpio_39*/
#define OTS_3P0            (G_GPIO_BASE + 63)   /*OTS 3p0 gpio gpio_63*/
